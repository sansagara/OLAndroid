 ...
 */
public class MyRVAdapterOpen extends RecyclerView.Adapter<MyRVAdapterOpen.ViewHolder>  {
    ...
    public MyRVAdapterOpen(Context context) {
        //Set the context.
        ...
        for (int i = 0; i < 20; ++i) {
            auctions.add(new Auction("Open Product " + i, "Open Description for Product " + i));
        }
    ...
    public MyRVAdapterOpen(Context context, ArrayList auctions_array) {
        //Set the context.
        this.context = context;
    ...
    @Override
    public MyRVAdapterOpen.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.content_ofertaloca_open_card, parent, false);
